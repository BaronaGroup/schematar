...
describe('json-schema-features', function() {
  ...
  it('allowNull', testJSONSchema({fields: {field: {type: String, allowNull: true, optional: true}}}, schema => {
    expect(schema).toMatchSnapshot()
  }))

  it('schemaId', testJSONSchema({fields: {field: {type: String, allowNull: true, optional: true}}}, schema => {
    expect(schema).toMatchSnapshot()
  }, {schemaId: 'myschema'}))
