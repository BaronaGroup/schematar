...
export function testJSONSchema(schema: Schema, assertFn: JsonSchemaAssertFn, options: JSONSchemaOptions = {}, context = 'json-schema') {
  return function() {
...
export function testTypescriptInterface(schema: Schema, assertFn: TsAssertFn, options: TSOptions = {omitExtraExports: true}, context = 'typescript') {
  return function() {
